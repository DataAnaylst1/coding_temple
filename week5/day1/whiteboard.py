...
# Understanding
# We want to make sure that each element in the list amts up to the highest number in the list.
# the highest number is left alone
# the difference between the highest number and the other numbers are are calculated and added together

# Plan
# We will need to alert Python of using the highest number listed as the target number to compare to the other numbers
# We will need to do a for loop to iterate over each number
# We can use a counter object and equal it to zero and add to the variable, c = 0
